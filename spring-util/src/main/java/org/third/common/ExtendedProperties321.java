 ...
 */
public class ExtendedProperties321 extends Hashtable {
    
    /**
     * Default configurations repository.
     */
    private ExtendedProperties321 defaults;
     ...
     */
    public ExtendedProperties321(String file) throws IOException {
        this(file, null);
    }
     ...
     * @throws IOException if a file error occurs
     */
    public ExtendedProperties321(String file, String defaultFile) throws IOException {
        this.file = file;
        ...
        if (defaultFile != null) {
            defaults = new ExtendedProperties321(defaultFile);
        }
    }
     ...
     */
    public void combine(ExtendedProperties321 props) {
     ...
     */
    public ExtendedProperties321 subset(String prefix) {
        ExtendedProperties321 c = new ExtendedProperties321();
        Iterator keys = getKeys();
     ...
     */
    public static ExtendedProperties321 convertProperties(Properties props) {
        ExtendedProperties321 c = new ExtendedProperties321();
